...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2021 at 06:27 PM
...
CREATE TABLE `devices` (
  ...
  `device_uid` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `purchases` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `is_rate_limit` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `devices`
  ADD PRIMARY KEY (`id`),
  ADD KEY `device_uid_ndx` (`device_uid`),
  ADD KEY `app_id_ndx` (`app_id`),
